...
namespace MusicManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var result = "The album was not created. Please try again. If the problem persists, please contact us at support@playlift.co.uk";
        ...
        {
            var result = "There was a problem deleting this album. Please try again. If the problem persists, please contact support@playlift.co.uk";
        ...
        {
            var result = "The song was not uploaded. Please try again. If the problem persists, please contact us at support@playlift.co.uk";
            var formCollection = form.Split('&');
            var trmservice = new WebService.WCFWebServiceJson();
            var artist = trmservice.GetArtist(WebSecurity.CurrentUserId);
            var util = new Utilities();
        ...
        {
            var result = "There was a problem deleting this song. Please try again. If the problem persists, please contact support@playlift.co.uk";
        ...
        {
            var result = "Your details have not been updated. Please try again. If the problem persists, please contact us at support@playlift.co.uk";
            var formCollection = form.Split('&');
            var trmservice = new WebService.WCFWebServiceJson();
            var artist = trmservice.GetArtist(WebSecurity.CurrentUserId);
            var util = new Utilities();
        ...
        {
            var result = "Your password has not been updated. Please try again. If the problem persists, please contact us at support@playlift.co.uk";
            var formCollection = form.Split('&');
            var model = new LocalPasswordModel();

            model.OldPassword = MusicManagerBase.ReturnFormItemValue(formCollection, "OldPassword");
            model.NewPassword = MusicManagerBase.ReturnFormItemValue(formCollection, "NewPassword");
            model.ConfirmPassword = MusicManagerBase.ReturnFormItemValue(formCollection, "ConfirmPassword");
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null && artistUser != null)
                {
                    try
                    {
                        ...
                        string from = "noreply@playlift.co.uk";
            ...
            if (ModelState.IsValid)
            {
                ...
                using (UsersContext db = new UsersContext())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        {
                            ModelState.AddModelError("ArtistRegistrationError", "There was an issue registering you. If the problemt persists, please contact us at info@playlift.co.uk");
                        }
                    }
                    else
                    {
