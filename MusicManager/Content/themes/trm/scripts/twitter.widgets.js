if (!window.__twttrlr) {
    (function (e, t) {
        ...
        function O(e, t) {
            var r;
            return !e && n && (r = l || A()), r ? (delete c[r.scriptId], r.body = t, r.execute()) : (f =
                r = new C(e, t), a[r.id] = r), r
        }
        ...
        function P() {
            var e = b(arguments),
                t = [],
                n, r;
            return typeof e[0] == "string" && (n = e.shift()), w(e[0]) && (t = e.shift()), r = e.shift(),
                O(n, function (e) {
                    function s() {
                        var i = D(b(t), n),
                            s;
                        typeof r == "function" ? s = r.apply(n, i) : s = r, typeof s == "undefined" &&
                            (s = n.exports), e(s)
                    }
                    var n = this,
                        i = [];
        ...
        function H() {
            var e = b(arguments),
                t, n;
            typeof e[e.length - 1] == "function" && (t = e.pop()), typeof e[e.length - 1] == "boolean" &&
                (n = e.pop());
            var r = new k(B(e, n), n);
            return t && r.then(t), r
        }
        ...
        function B(e, t) {
            var n = [];
            for (var r = 0, i; i = e[r]; r++) typeof i == "string" && (i = j(i)), w(i) && (i = new L(B(i,
                t), t)), n.push(i);
            return n
        }
        ...
        T.prototype.then = function (t) {
            var n = this;
            return this.started || (this.started = !0, this.start()), this.completed ? t.apply(e, this.results) :
                (this.callbacks = this.callbacks || [], this.callbacks.push(t)), this
            ...
            return (r = a[this.id]) ? (r.then(function () {
                ...
                e.loaded()
            }) : !this.force && E(N.loaded, this.id) > -1 ? this.loaded() : (n = q(this.id)) ? H(n,
                function () {
                    e.loaded()
                }) : this.load(), this)
            ...
            u[this.id] = t;
            var n = o.cloneNode(!1);
            this.scriptId = n.id = "LR" + ++i, n.type = "text/javascript", n.async = !0, n.onerror =
                function () {
                    throw new Error(t.path + " not loaded")
            }, n.onreadystatechange = n.onload = function (n) {
                n = e.event || n;
                if (n.type == "load" || E(["loaded", "complete"], this.readyState) > -1) this.onreadystatechange =
                    null, t.loaded()
            }, n.src = this.path, l = this, r[0].parentNode.insertBefore(n, r[0]), l = null, c[n.id] =
                this
        }, N.prototype.loaded = function () {
            this.complete()
        }, N.prototype.complete = function () {
            E(N.loaded, this.id) == -1 && N.loaded.push(this.id), delete u[this.id], T.prototype.complete
            ...
            var e, t, n = this,
                r;
            this.body ? this.execute() : (e = C.exports[this.id]) ? this.exp(e) : (t = a[this.id]) ? t.then(
                function (e) {
                    n.exp(e)
            ...
            var e = this;
            typeof this.body == "object" ? this.exp(this.body) : typeof this.body == "function" && this.body
                .apply(window, [
                    function (t) {
                        e.exp(t)
                    }
            ...
            function t() {
                ...
                for (var n = 0, r; r = e.deps[n]; n++) {
                    ...
                    r.results.length > 0 && (e.collectResults ? r instanceof L ? y(t[0], r.results[0]) :
                        x(t[0], r.id, r.results[0]) : t = t.concat(r.results))
                }
            ...
            function r() {
                var i = e.deps[t++];
                i ? i.then(function (t) {
                    i.results.length > 0 && (e.collectResults ? i instanceof L ? y(n[0], i.results[0]) :
                        x(n[0], i.id, i.results[0]) : n.push(i.results[0])), r()
        ...
        F.Script = N, F.Module = C, F.Collection = k, F.Sequence = L, F.Dependency = T, F.noConflict = I,
            e.loadrunner = F, e.using = H, e.provide = M, e.define = P, H.path = "", H.matchers = [], H.matchers
            .add = function (e, t) {
                this.unshift([e, t])
        }, H.matchers.add(/(^script!|\.js$)/, function (e) {
            var t = new N(e.replace(/^\$/, H.path.replace(/\/$/, "") + "/").replace(/^script!/, ""), !
                1);
            return t.id = e, t
        }), H.matchers.add(/^[a-zA-Z0-9_\-\/]+$/, function (e) {
            return new C(e)
        }), H.bundles = [], s && (H.path = s.getAttribute("data-path") || s.src.split(/loadrunner\.js/)[0] ||
            "", (main = s.getAttribute("data-main")) && H.apply(e, main.split(/\s*,\s*/)).then(function () {})
        )
    })(this, document);
...
__twttrlr(function (using, provide, loadrunner, define) {
    provide("util/util", function (e) {
        ...
        function n(e) {
            for (var t in e) e.hasOwnProperty(t) && (l(e[t]) && (n(e[t]), c(e[t]) && delete e[t]), (e[
                t] === undefined || e[t] === null || e[t] === "") && delete e[t]);
            return e
        }
    ...
    provide("util/events", function (e) {
        using("util/util", function (t) {
            ...
            var n = {
                bind: function (e, t) {
                    return this._handlers = this._handlers || {}, this._handlers[e] = this._handlers[
                        e] || [], this._handlers[e].push(t)
                },
                unbind: function (e, n) {
    ...
    provide("util/uri", function (e) {
        using("util/querystring", "util/util", "util/twitter", function (t, n, r) {
            function i(e, t) {
                var n, r;
                return t = t || location, /^https?:\/\//.test(e) ? e : /^\/\//.test(e) ? t.protocol +
                    e : (n = t.host + (t.port.length ? ":" + t.port : ""), e.indexOf("/") !== 0 &&
                        (r = t.pathname.split("/"), r.pop(), r.push(e), e = "/" + r.join("/")), [
                            t.protocol, "//", n, e
                        ].join(""))
            }
    ...
    provide("util/env", function (e) {
        using("util/domready", "util/typevalidator", "util/logger", "tfw/util/globals", function (t,
            n, r, i) {
            function f() {
                return (window.devicePixelRatio || Math.round(window.screen.availWidth / document
            ...
            function d() {
                return "ontouchstart" in window || /Opera Mini/.test(s) || navigator.msMaxTouchPoints >
                    0
            }

            function v() {
                var e = document.body.style;
                return e.transition !== undefined || e.webkitTransition !== undefined || e.mozTransition !==
                    undefined || e.oTransition !== undefined || e.msTransition !== undefined
            }
            ...
            twttr.verifyCSP = function (e) {
                ...
                e = document.createElement("script"), e.id = a, e.text =
                    "twttr.verifyCSP(false);", document.body.appendChild(e), window.setTimeout(
                        function () {
                            if (u) return;
                            r.warn(
    ...
    provide("dom/delegate", function (e) {
        using("util/env", function (t) {
            ...
            function a(e, t, r, s) {
                var o = i(e);
                n[o] = n[o] || {}, n[o][t] || (n[o][t] = {}, u(e, t, n[o])), n[o][t][r] = n[o][t]
                [r] || [], n[o][t][r].push(s)
            }

            function f(e, t, n) {
                e.addEventListener ? e.addEventListener(t, n, !1) : e.attachEvent("on" + t,
                    function () {
                        n(window.event)
                    })
            }
            ...
            function p(e) {
                e && (e.cease = !0) && e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !
                    0
            }
            var n = {}, r = -1;
            e({
            ...
            function s() {
                ...
                if (window == window.top) {
                    t.on(window, "message", function (e) {
                        ...
                        t && t.name == "twttr:private:requestArticleUrl" && e.source.postMessage(
                            JSON.stringify({
                ...
                t.on(window, "message", function (e) {
                    ...
                    t && t.name == "twttr:private:provideArticleUrl" && (i = t.data && t.data
                        .url, n.dnt(t.data.dnt))
    ...
    provide("util/iframe", function (e) {
        e(function (e) {
            var t = (e.replace && e.replace.ownerDocument || document).createElement("div"),
                n, r, i;
            t.innerHTML =
                "<iframe allowtransparency='true' frameBorder='0' scrolling='no'></iframe>", n =
                t.firstChild, n.src = e.url, n.className = e.className || "";
            if (e.css)
                for (r in e.css) e.css.hasOwnProperty(r) && (n.style[r] = e.css[r]);
            if (e.attributes)
                for (i in e.attributes) e.attributes.hasOwnProperty(i) && n.setAttribute(i, e.attributes[
                    i]);
            return e.replace ? e.replace.parentNode.replaceChild(n, e.replace) : e.insertTarget &&
                e.insertTarget.appendChild(n), n
        })
    });
        ...
        using("util/util", function (t) {
            function n(e, n, r, i) {
                var s, o, u = [],
                    a, f, l, c, h, p;
                n = n || document;
                if (t.isNative(n.getElementsByClassName)) return u = t.filter(n.getElementsByClassName(
                    e), function (e) {
            ...
            function i(e, n, r) {
                var s = n && n.parentNode,
                    o;
                if (!s || s === r) return;
                return s.tagName == e ? s : (o = s.className.split(" "), 0 === e.indexOf(".") && ~
                    t.indexOf(o, e.slice(1)) ? s : i(e, s, r))
            }
            e({
                all: n,
                one: r,
    ...
    provide("tfw/widget/base", function (e) {
        using("util/util", "util/domready", "dom/get", "tfw/util/globals", "util/querystring",
            "util/iframe", "util/typevalidator", function (t, n, r, i, s, o, u) {
                function p(e) {
                    var t;
                    if (!e) return;
                    e.ownerDocument ? (this.srcEl = e, this.classAttr = e.className.split(" ")) : (
                        this.srcOb = e, this.classAttr = []), t = this.params(), this.id = v(), this.setLanguage(),
                        this.related = t.related || this.dataAttr("related"), this.partner = t.partner ||
                        this.dataAttr("partner") || i.val("partner"), this.dnt = t.dnt || this.dataAttr(
                            "dnt") || i.dnt() || "", this.styleAttr = [], this.targetEl = e.targetEl
                }
                ...
                t.aug(p.prototype, {
                    setLanguage: function (e) {
                        var t;
                        e || (e = this.params().lang || this.dataAttr("lang") || m(this.srcEl)),
                            e = e && e.toLowerCase();
                    ...
                    params: function () {
                        var e, t;
                        return this.srcOb ? t = this.srcOb : (e = this.srcEl && this.srcEl.href &&
                            this.srcEl.href.split("?")[1], t = e ? s.decode(e) : {}), this.params =
                            function () {
                                return t
                        }, t
                    },
                    ...
                    dimensions: function () {
                        ...
                        this.minWidth() && (n["min-width"] = this.minWidth()), this.maxWidth() &&
                            (n["max-width"] = this.maxWidth()), this.minHeight() && (n[
                            "min-height"] = this.minHeight()), this.maxHeight() && (n[
                    ...
                    for (; i = e[s]; s++)
                        for (a in t)
                            if (t.hasOwnProperty(a)) {
                                a.match(/\./) ? (c = a.split("."), n = r.all(c[1], i, c[0])) : n = i.getElementsByTagName(
                                    a);
                                for (h = 0; p = n[h]; h++) {
                                    if (p.getAttribute("data-twttr-rendered")) continue;
                                    p.setAttribute("data-twttr-rendered", "true"), o = new t[a](p), l
                                        .list.push(o), l.byId[o.id] = o, o.render(f)
                                }
                            }
                    d()
                }, e(p)
        ...
        using("tfw/widget/base", "util/util", "util/querystring", "util/uri", function (t, n, r, i) {
            function h(e) {
                var t = Math.round(l / 2 - u / 2),
                    n = 0;
                f > a && (n = Math.round(f / 2 - a / 2)), window.open(e, undefined, [o, "width=" +
                    u, "height=" + a, "left=" + t, "top=" + n
                ].join(","))
            }
            ...
            function v(e) {
                ...
                t && t.href && (r = t.href.match(s), r && (o = d(t.href), o = o.replace(
                        /^http[:]/, "https:"), o = o.replace(/^\/\//, "https://"), m(o, t), e
                    .returnValue = !1, e.preventDefault && e.preventDefault()))
            }
            ...
            y.prototype = new t, n.aug(y.prototype, {
                render: function (e) {
                    c = this, window.__twitterIntentHandler || (document.addEventListener ?
                        document.addEventListener("click", v, !1) : document.attachEvent &&
                        document.attachEvent("onclick", v), window.__twitterIntentHandler = !
                        0)
                }
            }), y.open = m, e(y)
        })
        ...
        using("util/util", function (t) {
            e({
                sanitize: function (e, n, r) {
                    ...
                    for (; s && (u = s[o]); o++) u[0].match(n) && u[1].match(i) && a.push(u.join(
                        ":") + f);
                    return a.join(";")
                }
            })
        ...
        function () {
            ...
            function str(e, t) {
                ...
                case "object":
                    ...
                    if (rep && typeof rep == "object") {
                        s = rep.length;
                        for (n = 0; n < s; n += 1) r = rep[n], typeof r == "string" && (i = str(r, a),
                            i && u.push(quote(r) + (gap ? ": " : ":") + i))
                    } else
                        for (r in a) Object.hasOwnProperty.call(a, r) && (i = str(r, a), i && u.push(
                            quote(r) + (gap ? ": " : ":") + i));
                    return i = u.length === 0 ? "{}" : gap ? "{\n" + gap + u.join(",\n" + gap) + "\n" +
                        o + "}" : "{" + u.join(",") + "}", gap = o, i
                }
            ...
            typeof Date.prototype.toJSON != "function" && (Date.prototype.toJSON = function (e) {
                    return isFinite(this.valueOf()) ? this.getUTCFullYear() + "-" + f(this.getUTCMonth() +
                        1) + "-" + f(this.getUTCDate()) + "T" + f(this.getUTCHours()) + ":" + f(this.getUTCMinutes()) +
            ...
            typeof JSON.stringify != "function" && (JSON.stringify = function (e, t, n) {
                ...
                rep = t;
                if (!t || typeof t == "function" || typeof t == "object" && typeof t.length ==
                    "number") return str("", {
                    "": e
                });
                ...
                function walk(e, t) {
                    ...
                    if (i && typeof i == "object")
                        for (n in i) Object.hasOwnProperty.call(i, n) && (r = walk(i, n), r !==
    ...
    provide("tfw/util/env", function (e) {
        using("util/params", function (t) {
            function r() {
                ...
                return n !== undefined ? n : (n = !1, r && /^\d+$/.test(r) && (n = +(new Date) -
                    parseInt(r) < e), n)
            }
            var n;
            e({
        ...
        using("util/util", function (t) {
            e(function (e, n, r) {
                ...
                if (arguments.length > 1 && String(n) !== "[object Object]") {
                    ...
                    return n = String(n), document.cookie = [encodeURIComponent(e), "=", i.raw ?
                        n : encodeURIComponent(n), i.expires ? "; expires=" + i.expires.toUTCString() :
                        "", i.path ? "; path=" + i.path : "", i.domain ? "; domain=" + i.domain :
                        "", i.secure ? "; secure" : ""
                    ].join("")
                }
                i = n || {};
                ...
                return (u = (new RegExp("(?:^|; )" + encodeURIComponent(e) + "=([^;]*)")).exec(
                    document.cookie)) ? a(u[1]) : null
            })
        })
    });
    provide("util/donottrack", function (e) {
        using("dom/cookie", function (t) {
            e(function (e) {
                var n = /\.(gov|mil)(:\d+)?$/i,
                    r = /https?:\/\/([^\/]+).*/i;
                return e = e || document.referrer, e = r.test(e) && r.exec(e)[1], t("dnt") ? !
                    0 : n.test(document.location.host) ? !0 : e && n.test(e) ? !0 : document.navigator ?
                    document.navigator["doNotTrack"] == 1 : navigator ? navigator[
                        "doNotTrack"] == 1 || navigator["msDoNotTrack"] == 1 : !1
            })
        })
    });
    ...
    provide("dom/sandbox", function (e) {
        using("util/domready", "util/env", function (t, n) {
            function i(e, t) {
                ...
                i.allowtransparency = "true", i.scrolling = "no", i.setAttribute("frameBorder", 0),
            ...
            function s(e, t, n, r) {
                var s;
                this.attrs = t || {}, this.styles = n || {}, this.appender = r, this.onReady = e,
                    this.sandbox = {}, s = i(this.attrs, this.styles), s.onreadystatechange = s.onload =
                    this.getCallback(this.onLoad), this.sandbox.frame = s, r ? r(s) : document.body
                    .appendChild(s)
            }
            ...
            var r = 0;
            window.twttr || (window.twttr = {}), window.twttr.sandbox || (window.twttr.sandbox = {}),
                s.prototype.getCallback = function (e) {
                    var t = this,
                        n = !1;
                    return function () {
                        n || (n = !0, e.call(t))
                ...
                this.sandbox.win = this.sandbox.frame.contentWindow, this.sandbox.doc = this.sandbox
                    .frame.contentWindow.document, this.writeStandardsDoc(), this.sandbox.body =
                    this.sandbox.frame.contentWindow.document.body, this.onReady(this.sandbox)
            }, s.prototype.setDocDomain = function () {
                var e, t = this.registerCallback(this.getCallback(this.onLoad));
                e = ["javascript:", 'document.write("");', "try { window.parent.document; }",
                    "catch (e) {", 'document.domain="' + document.domain + '";', "}",
                    'window.parent.twttr.sandbox["' + t + '"]();'
                ].join(""), this.sandbox.frame.parentNode.removeChild(this.sandbox.frame), this.sandbox
                    .frame = null, this.sandbox.frame = i(this.attrs, this.styles), this.sandbox.frame
                    .src = e, this.appender ? this.appender(this.sandbox.frame) : document.body.appendChild(
                        this.sandbox.frame)
            }, s.prototype.writeStandardsDoc = function () {
                if (!n.anyIE() || n.cspEnabled()) return;
                var e = ["<!DOCTYPE html>", "<html>", "<head>", "<scr", "ipt>",
                    "try { window.parent.document; }", 'catch (e) {document.domain="' + document.domain +
    ...
    provide("tfw/util/tracking", function (e) {
        using("dom/cookie", "dom/delegate", "dom/sandbox", "util/donottrack", "tfw/util/guest_cookie",
            "tfw/util/env", "util/util", "$xd/json2.js", function (t, n, r, i, s, o, u) {
                function E() {
                ...
                function x(e, n, r, a) {
                    ...
                    if (!l) return;
                    e = e || {}, a = !! a, r = !! r, h = e.original_redirect_referrer || document.referrer,
                        a = a || i(h), c = u.aug({}, e), r || (T(c, "referrer", h), T(c, "widget", +o
                            .isDynamicWidget()), T(c, "hask", + !! t("k")), T(c, "li", + !! t(
                            "twid")), T(c, p, t(p) || "")), a && (T(c, "dnt", 1), H(c)), P(l + "?" +
                            M(c))
                }
                ...
                function N(e, t, n) {
                    ...
                    s = u.aug({}, t, {
                        ...
                        l: B(s)
                    }), P(a)) : (r = h.firstChild, r.value = +r.value || +s.dnt, o = B(s), i = g.createElement(
                        "input"), i.type = "hidden", i.name = "l", i.value = o, h.appendChild(i))
                }
                ...
                function O(e, t, n) {
                    ...
                    return t = !! t, n = !! n, s = u.aug(r, e || {}), o = s.widget_origin || document
                        .referrer, s.format_version = 1, s.dnt = n = n || i(o), s.triggered_on = s.triggered_on || +
                        (new Date), t || (s.widget_origin = o), n && H(s), s
                }

                function M(e) {
                    var t = [],
                        n, r, i;
                    for (n in e) e.hasOwnProperty(n) && (r = encodeURIComponent(n), i =
                        encodeURIComponent(e[n]), i = i.replace(/'/g, "%27"), t.push(r + "=" + i));
                    return t.join("&")
                }
                ...
                function _() {
                    ...
                    return c++, e.action = b, e.method = "POST", e.target = "rufous-frame-" + c, e.id =
                        "rufous-form-" + c, t.type = "hidden", t.name = "dnt", t.value = 0, n.type =
                        "hidden", n.name = "tfw_redirect", n.value = w, e.appendChild(t), e.appendChild(
                            n), e
                }
                ...
                function D() {
                    ...
                    return e.id = t, e.style.display = "none", e.width = 0, e.height = 0, e.border =
                        0, e
                }

                function P(e) {
                    var t = document.createElement("img");
                    t.src = e, t.alt = "", t.style.position = "absolute", t.style.height = "1px", t.style
                        .width = "1px", t.style.top = "-9999px", t.style.left = "-9999px", document.body
                        .appendChild(t)
                }
                ...
                function B(e) {
                    var t = Array.prototype.toJSON,
                        n;
                    return delete Array.prototype.toJSON, n = JSON.stringify(e), t && (Array.prototype
                        .toJSON = t), n
                }
                var a = "twttr_",
                    f = {
                    ...
                    }, l = ["hask", "li", "logged_in", "pid", "user_id", s.guest_id_cookie, a +
                        "hask", a + "li", a + s.guest_id_cookie
                    ],
                    c = 0,
                    h, p, d = [],
    ...
    provide("tfw/util/data", function (e) {
        using("util/logger", "util/util", "util/querystring", function (t, n, r) {
            ...
            function h(e) {
                return function (n) {
                    n.error ? e.error && e.error(n) : n.headers && n.headers.status != 200 ? (e.error &&
                        e.error(n), t.warn(n.headers.message)) : e.success && e.success(n), e.complete &&
                        e.complete(n), p(e)
                }
            }
            ...
            function p(e) {
                var t = e.script;
                t && (t.onload = t.onreadystatechange = null, t.parentNode && t.parentNode.removeChild(
                    t), e.script = undefined, t = undefined), e.callbackName && twttr.tfw.callbacks[
                    e.callbackName] && delete twttr.tfw.callbacks[e.callbackName]
            }

            function d(e) {
                var t = {};
                return e.success && c("function", e.success) && (t.success = e.success), e.error &&
                    c("function", e.error) && (t.error = e.error), e.complete && c("function", e.complete) &&
                    (t.complete = e.complete), t
            }
            ...
            function v(e, t, n) {
                ...
                return function (o) {
                    ...
                    u = n(o), i[u] = o;
                    if (++s === r) {
                        for (c = 0; c < r; c++) h = i[e[c]], a.push(h), h.error ? l.push(h) : f.push(
                            h);
                        t.error && l.length > 0 && t.error(l), t.success && f.length > 0 && t.success(
                            f), t.complete && t.complete(a)
                    }
                }
            }
            ...
            twttr.widgets && twttr.widgets.endpoints && n.aug(l, twttr.widgets.endpoints), f.jsonp =
                function (e, t, n) {
                    var f = n || o + u,
                        l = i + "." + f,
                    ...
                    s[f] = h(t);
                    if (a || !/^https?\:$/.test(window.location.protocol)) e = e.replace(/^\/\//,
                        "https://");
                    c.src = r.url(e, p), c.async = "async", document.body.appendChild(c), t.script =
                        c, t.callbackName = f, n || u++
            }, f.config = function (e) {
                if (e.forceSSL === !0 || e.forceSSL === !1) a = e.forceSSL
            }, f.user = function () {
                var e, t = {}, n, i, s;
                arguments.length === 1 ? (e = arguments[0].screenName, t = d(arguments[0])) : (e =
                    arguments[0], t.success = arguments[1]), n = c("array", e) ? l.userLookup : l
                    .userShow, e = c("array", e) ? e.join(",") : e, i = {
                        screen_name: e
                }, s = r.url(n, i), this.jsonp(s, t)
            }, f.userById = function (e) {
                var t, n = {}, i, s, o;
                arguments.length === 1 ? (t = e.ids, n = d(e)) : (t = e, n.success = arguments[1]),
                    i = c("array", t) ? l.userLookup : l.userShow, t = c("array", t) ? t.join(",") :
                    t, s = {
                        user_id: t
                }, o = r.url(i, s), this.jsonp(o, n)
            }, f.status = function () {
                var e, t = {}, n, i, s, o;
                arguments.length === 1 ? (e = arguments[0].id, t = d(arguments[0])) : (e =
                    arguments[0], t.success = arguments[1]);
                if (!c("array", e)) n = {
                    id: e,
                    include_entities: !0
                ...
                var e = "",
                    t, n, i = {};
                arguments.length === 1 ? (e = arguments[0].url, i = d(arguments[0])) : arguments.length ===
                    2 && (e = arguments[0], i.success = arguments[1]), n = {
                        url: e
                ...
                n.compact(a), s = r.url(l.timeline + e.id, a), this.jsonp(s, i, "tl_" + e.id +
                    "_" + e.instanceId)
                ...
                n.compact(s), o = r.url(l.timelinePoll + e.id, s), this.jsonp(o, i, "tlPoll_" + e
                    .id + "_" + e.instanceId + "_" + (e.sinceId || e.maxId))
    ...
    provide("anim/transition", function (e) {
        function t(e, t) {
            var n;
            return t = t || window, n = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t
                .mozRequestAnimationFrame || t.msRequestAnimationFrame || t.oRequestAnimationFrame ||
                function (n) {
        ...
        using("util/util", function (t) {
            ...
            function p(e) {
                ...
                this.timeAgo = function (e) {
                    var t = p.parseDate(e),
                        ...
                        o = s - t,
                        h;
                    return t ? isNaN(o) || o < u * 2 ? i("now") : o < a ? (h = Math.floor(o / u),
                        i(r.abbr, {
                            number: h,
                            symbol: i(c, {
                                abbr: i("s"),
            ...
            p.parseDate = function (e) {
                ...
                return a = function () {
                    ...
                    if (e = u.match(r)) return Date.UTC(e[7], t.indexOf(s, e[1]), e[2], e[3], e[4],
                        e[5]);
    ...
    provide("tfw/util/assets", function (e) {
        using("util/env", function (t) {
            function r(e, r) {
                var i = n[e],
                    s;
                return t.retina() ? s = "2x" : t.ie6() || t.ie7() ? s = "gif" : s = "default", r &&
                    (s += ".rtl"), i[s]
            }
            var n = {
                "embed/timeline.css": {
    ...
    provide("tfw/widget/syndicatedbase", function (e) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals",
            "dom/classname", "dom/delegate", "dom/sandbox", "util/env", "util/twitter", "util/util",
            function (t, n, r, i, s, o, u, a, f, l) {
                function y() {
                    v = E.VALID_COLOR.test(i.val("widgets:link-color")) && RegExp.$1, g = E.VALID_COLOR
                        .test(i.val("widgets:border-color")) && RegExp.$1, m = i.val("widgets:theme")
                }
                ...
                function b(e, t, n) {
                    ...
                    r = n.createElement("link"), r.id = e, r.rel = "stylesheet", r.type = "text/css",
                        r.href = twttr.widgets.config.assetUrl() + "/" + t, n.getElementsByTagName(
                ...
                function E(e) {
                    if (!e) return;
                    var n, r, i = this;
                    this.sandboxReadyCallbacks = [], t.apply(this, [e]), n = this.params(), this.targetEl =
                        this.srcEl && this.srcEl.parentNode || n.targetEl || document.body, this.containerWidth =
                        this.targetEl && this.targetEl.offsetWidth, r = n.width || this.attr("width") ||
                        this.containerWidth || this.dimensions.DEFAULT_WIDTH, this.height = E.VALID_UNIT
                        .test(n.height || this.attr("height")) && RegExp.$1, this.width = Math.max(
                            this.dimensions.MIN_WIDTH, Math.min(E.VALID_UNIT.test(r) ? RegExp.$1 :
                                this.dimensions.DEFAULT_WIDTH, this.dimensions.DEFAULT_WIDTH)), this.narrow =
                        n.narrow || this.width <= this.dimensions.NARROW_WIDTH, this.narrow && this.classAttr
                        .push("var-narrow"), E.VALID_COLOR.test(n.linkColor || this.dataAttr(
                            "link-color")) ? this.linkColor = RegExp.$1 : this.linkColor = v, E.VALID_COLOR
                        .test(n.borderColor || this.dataAttr("border-color")) ? this.borderColor =
                        RegExp.$1 : this.borderColor = g, this.theme = n.theme || this.attr(
                            "data-theme") || m, this.theme = /(dark|light)/.test(this.theme) ? this.theme :
                        "", this.classAttr.push(a.touch() ? "is-touch" : "not-touch"), u(function (e) {
                            ...
                            i.srcEl ? i.targetEl.insertBefore(e, i.srcEl) : i.targetEl.appendChild(
                                e)
                        })
                }
                var c = [".customisable", ".customisable:link", ".customisable:visited",
                    ".customisable:hover", ".customisable:focus", ".customisable:active",
                    ".customisable-highlight:hover", ".customisable-highlight:focus",
                    "a:hover .customisable-highlight", "a:focus .customisable-highlight"
                ],
                    h = ["a:hover .ic-mask", "a:focus .ic-mask"],
                    p = [".customisable-border"],
                    d = [".timeline-header h1.summary", ".timeline-header h1.summary a:link",
                ...
                E.prototype = new t, l.aug(E.prototype, {
                    setupSandbox: function (e) {
                        var t = e.doc,
                            ...
                            o = this,
                            u;
                        this.sandbox = e, e.frame.title = this.a11yTitle, w(e.doc), n.target =
                            "_blank", i.appendChild(n), a.cspEnabled() || (r.type = "text/css", r
                                .styleSheet ? r.styleSheet.cssText = s : r.appendChild(t.createTextNode(
                                    s)), i.appendChild(r)), this.handleResize && window.addEventListener ?
                    ...
                    callIfSandboxReady: function (e, t, n) {
                        n = n || [], t.frameIsReady ? e.apply(t, [!1].concat(n)) : t.sandboxReadyCallbacks
                            .push({
                                fn: e,
                                context: t,
                                args: [!0].concat(n)
                    ...
                    contentWidth: function () {
                        var e = this.dimensions,
                            t = this.chromeless && this.narrow ? e.NARROW_MEDIA_PADDING_CL : this
                                .chromeless ? e.WIDE_MEDIA_PADDING_CL : this.narrow ? e.NARROW_MEDIA_PADDING :
                    ...
                    addSiteStyles: function () {
                        ...
                        this.headingStyle && s.push(l.map(d, i).join(",") + "{" + this.headingStyle +
                            "}"), this.linkColor && (s.push(l.map(c, i).join(",") + "{color:" +
                            this.linkColor + "}"), s.push(l.map(h, i).join(",") +
                            "{background-color:" + this.linkColor + "}")), this.borderColor && s.push(
                            l.map(p, i).concat(this.theme == "dark" ? [
                                ".thm-dark.customisable-border"
                            ] : []).join(",") + "{border-color:" + this.borderColor + "}");
                        if (!s.length) return;
                        r = t.createElement("style"), r.id = n, r.type = "text/css", r.styleSheet ?
                            r.styleSheet.cssText = s.join("") : r.appendChild(t.createTextNode(s.join(
                ...
                }), E.VALID_UNIT = /^([0-9]+)( ?px)?$/, E.VALID_COLOR =
                    /^(#(?:[0-9a-f]{3}|[0-9a-f]{6}))$/i, E.retinize = function (e) {
                        if (!a.retina()) return;
                        var t = e.getElementsByTagName("IMG"),
                            n, r, i = 0,
                            s = t.length;
                        for (; i < s; i++) n = t[i], r = n.getAttribute("data-src-2x"), r && (n.src =
                            r)
                }, E.scaleDimensions = function (e, t, n, r) {
                    return t > e && t > r ? (e *= r / t, t = r) : e > n && (t *= n / e, e = n, t > r &&
                        (e *= r / t, t = r)), {
                        width: Math.ceil(e),
                        height: Math.ceil(t)
                    }
                    ...
                    for (; i = [n, r][a]; a++)
                        if (i.length)
                            for (f = 0; s = i[f]; f++) o = E.scaleDimensions(s.getAttribute("width") ||
                                s.width, s.getAttribute("height") || s.height, t, 375), o.width > 0 &&
                                (s.width = o.width), o.height > 0 && (s.height = o.height), u = o.height >
                                u ? o.height : u;
                    return u
                }, y(), e(E)
            })
    ...
    provide("tfw/widget/timeline", function (e) {
        using("tfw/widget/syndicatedbase", "util/datetime", "anim/transition", "tfw/util/article",
            "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env",
            "util/iframe", "util/insert", "util/throttle", "util/twitter", "util/querystring",
            "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function (
                t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b) {
                function I(e) {
                    if (!e) return;
                    var n, r, i, s, o, u, f;
                    this.a11yTitle = this._("Twitter Timeline Widget"), t.apply(this, [e]), n = this.params(),
                        r = (n.chrome || this.dataAttr("chrome") || "").split(" "), this.preview = n.previewParams,
                        this.widgetId = n.widgetId || this.dataAttr("widget-id"), this.instanceId = ++
                        F, (s = n.screenName || this.dataAttr("screen-name")) || (o = n.userId ||
                            this.dataAttr("user-id")) ? this.override = {
                            overrideType: "user",
                            overrideId: o,
                            overrideName: s,
                            withReplies: v.asBoolean(n.showReplies || this.dataAttr("show-replies")) ? "true" : "false"
                    } : (s = n.favoritesScreenName || this.dataAttr("favorites-screen-name")) || (o =
                        n.favoritesUserId || this.dataAttr("favorites-user-id")) ? this.override = {
                        overrideType: "favorites",
                        overrideId: o,
                        overrideName: s
                    } : ((s = n.listOwnerScreenName || this.dataAttr("list-owner-screen-name")) || (o =
                        n.listOwnerId || this.dataAttr("list-owner-id"))) && ((u = n.listId || this.dataAttr(
                        "list-id")) || (f = n.listSlug || this.dataAttr("list-slug"))) ? this.override = {
                        overrideType: "list",
                        overrideOwnerId: o,
                        overrideOwnerName: s,
                        overrideId: u,
                        overrideName: f
                    } : this.override = {}, this.tweetLimit = v.asInt(n.tweetLimit || this.dataAttr(
                        "tweet-limit")), this.staticTimeline = this.tweetLimit > 0, r.length && (i = ~
                        m.indexOf(r, "none"), this.chromeless = i || ~m.indexOf(r, "transparent"),
                        this.headerless = i || ~m.indexOf(r, "noheader"), this.footerless = i || ~m.indexOf(
                            r, "nofooter"), this.borderless = i || ~m.indexOf(r, "noborders"), this.noscrollbar = ~
                        m.indexOf(r, "noscrollbar")), this.headingStyle = a.sanitize(n.headingStyle ||
                        this.dataAttr("heading-style"), undefined, !0), this.classAttr.push(
                        "twitter-timeline-rendered"), this.ariaPolite = n.ariaPolite || this.dataAttr(
                        "aria-polite")
                }
                ...
                function q(e, n) {
                    var r = e.ownerDocument,
                        ...
                        h;
                    if (!l) return;
                    l.innerHTML = f.getAttribute("data-toggled-text"), f.setAttribute(
                        "data-toggled-text", c);
                    if (y.present(e, A)) {
                        y.remove(e, A);
                        if (!i) return;
                    ...
                    o && (u = r.createElement("DIV"), u.innerHTML = o, t.retinize(u), a = t.constrainMedia(
                        u, n), s.appendChild(u)), i && (h = Math.max(s.offsetHeight, a), i.style.cssText =
                        "height:" + h + "px"), y.add(e, A)
                }
                var w = "1.0",
                    E = {
                        CLIENT_SIDE_USER: 0,
                ...
                I.prototype = new t, m.aug(I.prototype, {
                    ...
                    dimensions: {
                        DEFAULT_HEIGHT: "600",
                        DEFAULT_WIDTH: "100", // modify this
                        NARROW_WIDTH: "100", // modify this
                        MIN_WIDTH: "100", // modify this
                        MIN_HEIGHT: "200", // modify this
                    ...
                    create: function (e) {
                        ...
                        if (!r) return;
                        this.reconfigure(e.config), this.discardStaticOverflow(r), this.augmentWidgets(
                            r), t.retinize(r), t.constrainMedia(r, this.contentWidth()), this.searchQuery =
                            r.getAttribute("data-search-query"), this.profileId = r.getAttribute(
                                "data-profile-id"), c = this.getTweetDetails(n);
                        ...
                        }, !0, this.dnt), o.flush(), this.ariaPolite == "assertive" && (a = b.one(
                            x, r, "DIV"), a.setAttribute("aria-polite", "assertive")), r.id =
                            this.id, r.className += " " + this.classAttr.join(" "), r.lang = this
                            .lang, twttr.widgets.load(r), f = function () {
                                s.sandbox.body.appendChild(r), s.staticTimeline ? s.sandbox.win.setTimeout(
                                    function () {
                                    ...
                                    var e = b.one(T, r, "DIV"),
                                        t = b.one(N, r, "DIV"),
                                        n = b.one(C, r, "DIV");
                                    t ? u = e.offsetHeight + t.offsetHeight : u = e.offsetHeight,
                                        n.style.cssText = "height:" + (s.height - u - 2) +
                                        "px", s.noscrollbar && s.hideStreamScrollBar()
                                }, 500), s.sandbox.frame.style.cssText = "", s.sandbox.frame.width =
                                    s.width, s.sandbox.frame.height = s.height, s.sandbox.frame.style
                                    .border = "none", s.sandbox.frame.style.maxWidth = "100%", s.sandbox
                                    .frame.style.minWidth = s.dimensions.MIN_WIDTH + "%" // modify this
                        }, this.callsWhenSandboxReady(f)(), this.srcEl && this.srcEl.parentNode &&
                            this.srcEl.parentNode.removeChild(this.srcEl), r
                    },
                    render: function (e, t) {
                        function u() {
                            r.success = function (e) {
                                n.element = n.create(e), n.readTranslations(), n.bindInteractions(),
                                    t && t(n.sandbox.frame);
                                return
                            }, r.error = function (e) {
                        ...
                        function a() {
                            o.initPostLogging(), s.timeline(m.aug({
                                ...
                                success: function (e) {
                                    n.element = n.create(e), n.readTranslations(), n.bindInteractions(),
                                        e.headers.xPolling && /\d/.test(e.headers.xPolling) &&
                                        (n.pollInterval = e.headers.xPolling * 1e3), n.updateTimeStamps(),
                                        n.staticTimeline || n.schedulePolling(), t && t(n
                                            .sandbox.frame);
                                    return
                                },
                                error: function (e) {
                        ...
                        i = this.preview ? u : a, this.sandboxReady ? i() : window.setTimeout(i,
                            0)
                    },
                    reconfigure: function (e) {
                        this.lang = e.lang, this.theme || (this.theme = e.theme), this.theme ==
                            "dark" && this.classAttr.push("thm-dark"), this.chromeless && this.classAttr
                            .push("var-chromeless"), this.borderless && this.classAttr.push(
                                "var-borderless"), this.headerless && this.classAttr.push(
                                "var-headerless"), this.footerless && this.classAttr.push(
                                "var-footerless"), this.staticTimeline && this.classAttr.push(
                                "var-static"), !this.linkColor && e.linkColor && t.VALID_COLOR.test(
                                e.linkColor) && (this.linkColor = RegExp.$1), this.addSiteStyles(), !
                            this.height && t.VALID_UNIT.test(e.height) && (this.height = RegExp.$1),
                            this.height = Math.max(this.dimensions.MIN_HEIGHT, this.height ? this
                                .height : this.dimensions.DEFAULT_HEIGHT), this.preview && this.classAttr
                            .push("var-preview"), this.narrow = this.width <= this.dimensions.NARROW_WIDTH,
                    ...
                    getTweetDetails: function (e) {
                        ...
                        for (; r = t[a]; a++) i = b.one(_, r, "A"), s = p.status(i.href), o = r.getAttribute(
                            "data-tweet-id"), s === o ? n[s] = {
                            item_type: u.TWEET
                        } : n[s] = {
                            item_type: u.RETWEET,
                            target_type: u.TWEET,
                    ...
                    bindInteractions: function () {
                        var e = this,
                            t = this.element,
                            n = !0;
                        this.bindIntentHandlers(), g.delegate(t, "click", ".load-tweets",
                            function (t) {
                    ...
                    loadMore: function () {
                        ...
                        this.requestTweets(n, !1, function (t) {
                            var r = b.one(P, e.element, "P"),
                                i = t.childNodes[0];
                            r.style.cssText = "", i && i.getAttribute("data-tweet-id") == n &&
                                t.removeChild(i);
                    ...
                    forceLoad: function () {
                        ...
                        this.requestTweets(1, !0, function (n) {
                            n.childNodes.length && (e[t ? "insertNewTweets" : "appendTweets"]
                                (n), y.add(e.element, "has-tweets"))
                        })
                    },
                    schedulePolling: function (e) {
                        var t = this;
                        if (this.pollInterval === null) return;
                        e = twttr.widgets.poll || e || this.pollInterval || 1e4, e > -1 && window
                            .setTimeout(function () {
                    ...
                    requestTweets: function (e, n, r) {
                        ...
                        a[n ? "sinceId" : "maxId"] = e, a.complete = function () {
                            ...
                            var s = u.sandbox.doc.createDocumentFragment(),
                                ...
                                f = [],
                                l, c;
                            e && e.headers && e.headers.xPolling && /\d+/.test(e.headers.xPolling) &&
                                (u.pollInterval = e.headers.xPolling * 1e3);
                    ...
                    insertNewTweets: function (e) {
                        var t = this,
                            ...
                            s = i.offsetHeight,
                            o;
                        this.updateTimeStamps(), i.insertBefore(e, i.firstChild), o = i.offsetHeight -
                            s;
                        if (n.scrollTop > 40 || this.mouseIsOver()) {
                            n.scrollTop = n.scrollTop + o, this.showNewTweetNotifier();
                            return
                        }
                        y.remove(this.element, H), i.style.cssText = "margin-top: -" + o + "px",
                            window.setTimeout(function () {
                                n.scrollTop = 0, y.add(t.element, H), f.cssTransitions() ? i.style
                                    .cssText = "" : r.animate(function (e) {
                                        e < o ? i.style.cssText = "margin-top: -" + (o -
                                            e) + "px" : i.style.cssText = ""
                                    }, o, 500, r.easeOut)
                    ...
                    showNewTweetNotifier: function () {
                        var e = this,
                            ...
                            n = t.children[0];
                        t.style.cssText = "", y.add(this.element, B), t.removeChild(n), t.appendChild(
                            n), y.replace(this.element, B, j), this.newNoticeDisplayTime = +(new Date),
                            window.setTimeout(function () {
                                e.hideNewTweetNotifier()
                            }, 5e3)
                    },
                    ...
                    augmentWidgets: function (e) {
                        var t = b.all(D, e, "A"),
                            n = 0,
                            r;
                        for (; r = t[n]; n++) r.setAttribute("data-related", this.related), r.setAttribute(
                            "data-partner", this.partner), r.setAttribute("data-dnt", this.dnt),
                            r.setAttribute("data-search-query", this.searchQuery), r.setAttribute(
                                "data-profile-id", this.profileId), this.width < 250 && r.setAttribute(
                    ...
                    hideStreamScrollBar: function () {
                        var e = b.one(C, this.element, "DIV"),
                            ...
                            n;
                        e.style.width = "", n = this.element.offsetWidth - t.offsetWidth, n > 0 &&
                            (e.style.width = this.element.offsetWidth + n + "px")
                    },
                    ...
                    updateTimeStamps: function () {
                        var e = b.all(_, this.element, "A"),
                            ...
                            i, s;
                        for (; t = e[r]; r++) {
                            i = t.getAttribute("data-datetime"), s = i && this.datetime.timeAgo(i,
                                this.i18n), n = t.getElementsByTagName("TIME")[0];
                            if (!s) continue;
                            if (n && n.innerHTML) {
                                n.innerHTML = s;
                                continue
                    ...
                    showNSFW: function (e) {
                        var n = b.one("nsfw", e, "DIV"),
                            ...
                            o, u, a, l;
                        if (!n) return;
                        i = t.scaleDimensions(n.getAttribute("data-width"), n.getAttribute(
                            "data-height"), this.contentWidth(), n.getAttribute("data-height")),
                            r = !! (u = n.getAttribute("data-player")), r ? a = this.sandbox.doc.createElement(
                                "iframe") : (a = this.sandbox.doc.createElement("img"), u = n.getAttribute(
                                    f.retina() ? "data-image-2x" : "data-image"), a.alt = n.getAttribute(
                                    "data-alt"), l = this.sandbox.doc.createElement("a"), l.href =
                                n.getAttribute("data-href"), l.appendChild(a)), a.title = n.getAttribute(
                                "data-title"), a.src = u, a.width = i.width, a.height = i.height,
                            o = b.ancestor("." + O, n, e), s = i.height - n.offsetHeight, n.parentNode
                            .replaceChild(r ? a : l, n), o.style.cssText = "height:" + (o.offsetHeight +
                                s) + "px"
                    },
                    handleResize: function () {
                        this.handleResize = h(function () {
                            var e = Math.min(this.dimensions.DEFAULT_WIDTH, Math.max(this.dimensions
                                .MIN_WIDTH, this.sandbox.frame.offsetWidth));
                            if (!this.element) return;
                            e < this.dimensions.NARROW_WIDTH ? (this.narrow = !0, y.add(this.element,
                                "var-narrow")) : (this.narrow = !1, y.remove(this.element,
                                "var-narrow")), this.noscrollbar && this.hideStreamScrollBar()
    ...
    provide("tfw/widget/embed", function (e) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params",
            "dom/classname", "dom/get", "util/env", "util/util", "util/throttle", "util/twitter",
            "tfw/util/article", "tfw/util/data", "tfw/util/tracking", function (t, n, r, i, s, o, u,
                a, f, l, c, h, p) {
                function g(e, t, n) {
                ...
                function w(e) {
                    if (!e) return;
                    var t, r, i;
                    this.a11yTitle = this._("Embedded Tweet"), n.apply(this, [e]), t = this.params(),
                        r = this.srcEl && this.srcEl.getElementsByTagName("A"), i = r && r[r.length -
                            1], this.hideThread = (t.conversation || this.dataAttr("conversation")) ==
                        "none" || ~a.indexOf(this.classAttr, "tw-hide-thread"), this.hideCard = (t.cards ||
                            this.dataAttr("cards")) == "hidden" || ~a.indexOf(this.classAttr,
                            "tw-hide-media");
                    if ((t.align || this.attr("align")) == "left" || ~a.indexOf(this.classAttr,
                        "tw-align-left")) this.align = "left";
                    else if ((t.align || this.attr("align")) == "right" || ~a.indexOf(this.classAttr,
                        "tw-align-right")) this.align = "right";
                    else if ((t.align || this.attr("align")) == "center" || ~a.indexOf(this.classAttr,
                        "tw-align-center")) this.align = "center", this.containerWidth > this.dimensions
                        .MIN_WIDTH * (1 / .7) && this.width > this.containerWidth * .7 && (this.width =
                            this.containerWidth * .7);
                    this.narrow = t.narrow || this.width <= this.dimensions.NARROW_WIDTH, this.narrow &&
                        this.classAttr.push("var-narrow"), this.tweetId = t.tweetId || i && l.status(
                            i.href)
                }
                var d = "2.0",
                    v = "tweetembed",
                ...
                w.prototype = new n, a.aug(w.prototype, {
                    ...
                    create: function (e) {
                        ...
                        if (!r) return;
                        return this.theme == "dark" && this.classAttr.push("thm-dark"), this.linkColor &&
                            this.addSiteStyles(), this.augmentWidgets(r), n.retinize(r), n.constrainMedia(
                                r, this.contentWidth()), r.id = this.id, r.className += " " +
                            this.classAttr.join(" "), r.lang = this.lang, twttr.widgets.load(r),
                            this.sandbox.body.appendChild(r), s.cssText = "", i.width = this.width,
                            i.height = 0, s.display = "block", s.border = "none", s.maxWidth =
                            "99%", s.minWidth = this.dimensions.MIN_WIDTH + "px", s.padding = "0",
                            g(r, this.partner, this.dnt), r
                    },
                    render: function (e, t) {
                        var n = this,
                            r = "",
                            ...
                            s, o, u;
                        if (!i) return;
                        this.hideCard && (r += "c"), this.hideThread && (r += "t"), r && (i +=
                            "-" + r), u = this.callsWhenSandboxReady(function (e) {
                            function r() {
                                var e = n.sandbox.frame,
                                    t = e.style;
                                n.srcEl && n.srcEl.parentNode && n.srcEl.parentNode.removeChild(
                                    n.srcEl), t.borderRadius = "5px", t.margin = "10px 0", t.border =
                                    "#ddd 1px solid", t.borderTopColor = "#eee", t.borderBottomColor =
                                    "#bbb", t.boxShadow = "0 1px 3px rgba(0,0,0,0.15)", n.align ==
                                    "center" ? (t.margin = "7px auto", t.float = "none") : n.align &&
                                    (n.width == n.dimensions.DEFAULT_WIDTH && (e.width = n.dimensions
                                    .NARROW_WIDTH), t.float = n.align), n.handleResize()
                            }
                            var t;
                            if ((!window.getComputedStyle || n.sandbox.win.getComputedStyle(n
                                .sandbox.body, null).display !== "none") && n.element.offsetHeight)
                                return r();
                            t = window.setInterval(function () {
                                (!window.getComputedStyle || n.sandbox.win.getComputedStyle(
                                    n.sandbox.body, null).display !== "none") && n.element
                                    .offsetHeight && (window.clearInterval(t), r())
                            }, 100)
                        }), s = this.callsWhenSandboxReady(function (e, r) {
                            n.element = n.create(r), n.readTimestampTranslations(), n.updateTimeStamps(),
                                n.bindIntentHandlers(), t && t(n.sandbox.frame)
                    ...
                    augmentWidgets: function (e) {
                        var t = o.all("twitter-follow-button", e, "A"),
                            n, r = 0;
                        for (; n = t[r]; r++) n.setAttribute("data-related", this.related), n.setAttribute(
                            "data-partner", this.partner), n.setAttribute("data-dnt", this.dnt),
                            n.setAttribute("data-show-screen-name", "false")
                    },
                    addUrlParams: function (e) {
                        var t = this,
                            n = {
                    ...
                    handleResize: function () {
                        this.handleResize = f(function () {
                            var e = this,
                                t = Math.min(this.dimensions.DEFAULT_WIDTH, Math.max(this.dimensions
                                    .MIN_WIDTH, this.sandbox.frame.offsetWidth));
                            if (!this.element) return;
                            t < this.dimensions.NARROW_WIDTH ? (this.narrow = !0, s.add(this.element,
                                "var-narrow")) : (this.narrow = !1, s.remove(this.element,
                                "var-narrow")), window.setTimeout(function () {
                        ...
                        complete: function (t) {
                            ...
                            for (n in t)
                                if (t.hasOwnProperty(n)) {
                                    o = e[n] && e[n];
                                    for (i = 0; o.length && (s = o[i]); i++) s.s && (s.s.call(
                                        this, t[n]), s.r && a.push(s.r));
                                    delete e[n]
                                }
                            ...
                            for (r in e)
                                if (e.hasOwnProperty(r)) {
                                    o = e[r];
                                    for (i = 0; o.length && (s = o[i]); i++) s.f && s.f.call(this,
                                        t[n])
                                }
                            p.flush()
                        }
    ...
    provide("dom/textsize", function (e) {
        ...
        e(function (e, i, s) {
            ...
            return o.innerHTML = e, document.body.appendChild(o), u.width = o.clientWidth || o.offsetWidth,
                u.height = o.clientHeight || o.offsetHeight, document.body.removeChild(o), delete o,
                t[a] = u
        })
    });
    provide("tfw/widget/tweetbase", function (e) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/twitter", "util/uri",
            function (t, n, r, i, s) {
                function a(e) {
                    if (!e) return;
                    var t;
                    n.apply(this, [e]), t = this.params(), this.text = t.text || this.dataAttr("text"),
                        this.text && /\+/.test(this.text) && !/ /.test(this.text) && (this.text =
                            this.text.replace(/\+/g, " ")), this.align = t.align || this.dataAttr(
                            "align") || "", this.via = t.via || this.dataAttr("via"), this.placeid =
                        t.placeid || this.dataAttr("placeid"), this.hashtags = t.hashtags || this.dataAttr(
                            "hashtags"), this.screen_name = i.screenName(t.screen_name || t.screenName ||
                            this.dataAttr("button-screen-name")), this.url = t.url || this.dataAttr(
                            "url")
                }
    ...
    provide("tfw/widget/tweetbutton", function (e) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter",
            "dom/textsize", function (t, n, r, i, s, o) {
                var u = document.title,
                    ...
                    l = function (e) {
                        ...
                        if (r.type == "hashtag" || ~n.indexOf(this.classAttr,
                            "twitter-hashtag-button")) this.type = "hashtag";
                        else if (r.type == "mention" || ~n.indexOf(this.classAttr,
                            "twitter-mention-button")) this.type = "mention";
                        this.counturl = r.counturl || this.dataAttr("counturl"), this.searchlink = r.searchlink ||
                            this.dataAttr("searchlink"), this.button_hashtag = s.hashTag(r.button_hashtag ||
                                r.hashtag || this.dataAttr("button-hashtag"), !1), this.size = l ==
                            "large" ? "l" : "m", this.type ? (this.count = "none", c && (this.related =
                                this.related ? c + "," + this.related : c)) : (this.text = this.text ||
                                u, this.url = this.url || i.getCanonicalURL() || a, this.count = ~n.indexOf(
                                    f, o) ? o : "horizontal", this.count = this.count == "vertical" &&
                ...
                l.prototype = new t, n.aug(l.prototype, {
                    ...
                    width: function () {
                        var e = {
                            ...
                            r = this.type == "hashtag" && this.button_hashtag ?
                                "Tweet %{hashtag}" : this.type == "mention" && this.screen_name ?
                                "Tweet to %{name}" : "Tweet",
                            i = this._(r, {
                            ...
                            p = this.styles.base,
                            d = p;
                        return~ n.indexOf(["ja", "ko"], this.lang) ? a += this._("10k unit") : a =
                            a.length > u.length ? a : u, t ? (d = p.concat(this.styles.vbubble),
                                h = e.ver, c = e.btn) : this.size == "l" ? (p = d = p.concat(this
                                .styles.large), c = e.xlbtn, h = e.xlcnt) : (c = e.btn, h = e.cnt),
                            this.count != "none" && (l = o(a, "", d).width + h), f = o(i, "", p.concat(
                                this.styles.button)).width + c, t ? f > l ? f : l : this.calculatedWidth =
                            f + l
                    },
                    render: function (e, t) {
                        var n = twttr.widgets.config.assetUrl() +
                            "/widgets/tweet_button.1375828408.html#" + this.parameters();
                        this.count && this.classAttr.push("twitter-count-" + this.count), this.element =
                            this.create(n, this.dimensions(), {
    ...
    provide("tfw/widget/follow", function (e) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter",
            "dom/textsize", function (t, n, r, i, s, o) {
                function u(e) {
                    if (!e) return;
                    var t, r, i, o, u;
                    n.apply(this, [e]), t = this.params(), r = t.size || this.dataAttr("size"), i = t
                        .showScreenName || this.dataAttr("show-screen-name"), u = t.count || this.dataAttr(
                            "count"), this.classAttr.push("twitter-follow-button"), this.showScreenName =
                        i != "false", this.showCount = t.showCount !== !1 && this.dataAttr(
                            "show-count") != "false", u == "none" && (this.showCount = !1), this.explicitWidth =
                        t.width || this.dataAttr("width") || "", this.screenName = t.screen_name || t
                        .screenName || s.screenName(this.attr("href")), this.preview = t.preview ||
                        this.dataAttr("preview") || "", this.align = t.align || this.dataAttr("align") ||
                ...
                u.prototype = new n, t.aug(u.prototype, {
                    ...
                    render: function (e, t) {
                        ...
                        var n = twttr.widgets.config.assetUrl() +
                            "/widgets/follow_button.1375828408.html#" + this.parameters();
                    ...
                    width: function () {
                        ...
                        var e = {
                            ...
                            i = ~t.indexOf(["ja", "ko"], this.lang) ? this._("10k unit") : this._(
                                "M"),
                        ...
                        return this.size == "l" ? (c = c.concat(this.styles.large), f = e.xlbtn,
                            l = e.xlcnt) : (f = e.btn, l = e.cnt), this.showCount && (a = o(s, "",
                            c).width + l), u = o(r, "", c.concat(this.styles.button)).width + f,
                            this.calculatedWidth = u + a
                    }
                }), e(u)
            })
    });
    ! function () {
        function e(e) {
            return (e || !/^http\:$/.test(window.location.protocol)) && !twttr.ignoreSSL ? "https" :
                "http"
        }
        ...
        }, using.path.length || (using.path = e() + "://" + twttr.host + "/js"), twttr.ignoreSSL = twttr.ignoreSSL || !
            1;
        var t = [];
        twttr.events = {
            bind: function (e, n) {
            ...
            n(function () {
                using("tfw/widget/base", "tfw/widget/follow", "tfw/widget/tweetbutton",
                    "tfw/widget/embed", "tfw/widget/timeline", "tfw/widget/intent",
                    "tfw/util/article", "util/events", "util/util", function (n, r, i, s, o, u, a,
                        f, l) {
                        function m(t) {
                            var n = twttr.host;
                            return e(t) == "https" && twttr.secureHost && (n = twttr.secureHost),
                                e(t) + "://" + n
                        }
                        ...
                        }), l.aug(twttr.events, d, f.Emitter), v = twttr.events.bind, twttr.events
                            .bind = function (e, t) {
                        ...
                        twttr.ready = function (e) {
                            e(twttr)
                        }, /twitter\.com(\:\d+)?$/.test(document.location.host) && (twttr.widgets
                            .createTimelinePreview = function (e, t, n) {
                                if (!p || !t) return n && n(!1);
                                (new o({
                                    previewParams: e,
                                    targetEl: t,
                            ...
                            }), twttr.widgets.createTweetEmbed = twttr.widgets.createTweet, twttr
                            .widgets.load()
                    })
            })
        })
