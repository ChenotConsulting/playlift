        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                percentageText.style.color = '#7d7d7d';
                percentageText.style.font = fontSize.toString() + 'px proxima-nova';
                ...
                smallSize = cX / 5.5;
                valueText.style.color = '#7d7d7d';
                valueText.style.font = smallSize.toString() + 'px proxima-nova';
