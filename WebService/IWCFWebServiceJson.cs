...
{
    [ServiceContract]
    public interface IWCFWebServiceJson
    {
        ...
        List<Artist> GetArtistsPlayedByVenue(int userId);
        List<Song> GetSongCountByArtistAndVenue(int artistUserId, int venueUserId);
